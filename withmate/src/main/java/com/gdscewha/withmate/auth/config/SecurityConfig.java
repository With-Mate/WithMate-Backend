...
import com.gdscewha.withmate.auth.jwt.JwtAuthenticationFilter;
import com.gdscewha.withmate.auth.jwt.JwtAuthorizationFilter;
import com.gdscewha.withmate.auth.jwt.JwtTokenProvider;
import com.gdscewha.withmate.auth.login.AuthDetailService;
...
public class SecurityConfig {
    ...
    // 로그인: 사용자의 자격 증명 검증 및 권한 부여
    @Bean
    public AuthenticationManager authenticationManager() throws Exception {
        return authenticationConfiguration.getAuthenticationManager();
    }

    // 로그인: 사용자 정보를 토대로 토큰을 생성하거나 검증 */
    @Bean
